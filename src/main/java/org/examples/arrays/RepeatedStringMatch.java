 ...
 * Example 1:
 * 
 * Input: a = "abcd", b = "cdabcdab" Output: 3 Explanation: We return 3 because
 * by repeating a three times "abcdabcdabcd", b is a substring of it. Example 2:
 * 
 * Input: a = "a", b = "aa" Output: 2 Example 3:
 * 
 * Input: a = "a", b = "a" Output: 1 Example 4:
 * 
 * Input: a = "abc", b = "wxyz" Output: -1
 * 
 * Constraints:
 * 
 * 1 <= a.length <= 104 1 <= b.length <= 104 a and b consist of lower-case
 * English letters.
 * 
 * @author rkata
 *
