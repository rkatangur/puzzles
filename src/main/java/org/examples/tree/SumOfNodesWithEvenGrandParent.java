 ...
 * 
 * 
 * Input: root = [6,7,8,2,7,1,3,9,null,1,4,null,null,null,5] Output: 18
 ...
 * Constraints:
 * 
 * The number of nodes in the tree is between 1 and 10^4. The value of nodes is
 * between 1 and 100.
 * 
 * 
 * @author rkata
...
public class SumOfNodesWithEvenGrandParent {
	...
	public int sumEvenGrandparentHelper(TreeNode root, TreeNode parent, TreeNode grandParent) {
		...
		sum += sumEvenGrandparentHelper(root.left, root, parent);
		sum += sumEvenGrandparentHelper(root.right, root, parent);
